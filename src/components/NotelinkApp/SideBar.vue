        ...
        <div class="mt-8">
          <ul class="flex flex-col gap-2">
            ...
            <router-link :to="{name: 'notes-home'}">
              <li @click="closeSidebar" class="flex gap-4 items-center pl-6 py-3"><img class="w-5"
            ...
            <div v-if="open"
              ...
              <router-link to="notes">
                <div @click="closeSidebar" class="sublink py-3 pl-[60px] flex items-center justify-between pr-4">
...
export default {
  emits: ['search-input', 'close-sidebar'],
  computed: {
    NotesArchive() {
      return NotesArchive
    }
  ...
  methods: {
    ...
    handleClickOutside(event) {
      ...
      if (this.isMobile && sidebar && !sidebar.contains(event.target) && !button.contains(event.target)) {
        this.$emit('close-sidebar');
      }
    },
  },
